...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        List<TestRequest>tr=new ArrayList<TestRequest>();
        try{
            tr=testRequestQueryService.findBy(RequestStatus.LAB_TEST_COMPLETED);
        }catch(Exception e){
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        try{
            ...
            tr=testRequestQueryService.findByDoctor(user);
        }catch(Exception e){
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        // Implement this method
        TestRequest assignForConsultation=null;
        ...
        try {
            User user = userLoggedInService.getLoggedInUser();
            assignForConsultation=testRequestUpdateService.assignForConsultation(id,user);
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        TestRequest updateConsultation= null;
        try {
            // replace this line of code with your implementation
            User user = userLoggedInService.getLoggedInUser();

            updateConsultation=testRequestUpdateService.updateConsultation(id,testResult,user);
            //throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
